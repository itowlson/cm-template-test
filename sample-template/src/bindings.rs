    ...
    pub mod fermyon {
        ...
        pub mod spin_template {
            ...
            pub mod template {
                ...
                #[derive(Clone)]
                pub enum Action {
                    CopyFileSubstituted((_rt::String, _rt::String)),
                    CopyFileRaw((_rt::String, _rt::String)),
                    ...
                    fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
                        match self {
                            Action::CopyFileSubstituted(e) => f
                                ...
                                .field(e)
                                .finish(),
                            Action::CopyFileRaw(e) => {
                                f.debug_tuple("Action::CopyFileRaw").field(e).finish()
                            }
                            Action::WriteFile(e) => {
                                ...
                                let base = result19.add(i * 20);
                                {
                                    match e {
                                        ...
                                        Action::WriteFile(e) => {
                                            ...
                                            *base.add(4).cast::<*mut u8>() = ptr14.cast_mut();
                                        ...
                                        Action::WriteFileBinary(e) => {
                                            ...
                                            *base.add(8).cast::<usize>() = len17;
                                            *base.add(4).cast::<*mut u8>() = ptr17.cast_mut();
                                            let vec18 = (t16_1).into_boxed_slice();
                                            let ptr18 = vec18.as_ptr().cast::<u8>();
                                            let len18 = vec18.len();
                                            ::core::mem::forget(vec18);
                                            *base.add(16).cast::<usize>() = len18;
                                            *base.add(12).cast::<*mut u8>() = ptr18.cast_mut();
                                        }
                                    }
                                }
                            }
                            *ptr1.add(16).cast::<usize>() = len19;
                            *ptr1.add(12).cast::<*mut u8>() = result19;
                        }
                        Err(e) => {
                            *ptr1.add(0).cast::<u8>() = (1i32) as u8;
                            ...
                            match e {
                                V21::Other(e) => {
                                    ...
                                    *ptr1.add(12).cast::<usize>() = len20;
                                    *ptr1.add(8).cast::<*mut u8>() = ptr20.cast_mut();
                                }
                            }
                        }
                    };
                ...
                pub unsafe fn __post_return_run<T: Guest>(arg0: *mut u8) {
                    ...
                    match l0 {
                        0 => {
                            ...
                            let l26 = *arg0.add(12).cast::<*mut u8>();
                            let l27 = *arg0.add(16).cast::<usize>();
                            let base28 = l26;
                            let len28 = l27;
                            for i in 0..len28 {
                        ...
                        _ => {
                            let l29 = i32::from(*arg0.add(4).cast::<u8>());
                            match l29 {
                                _ => {
                                    let l30 = *arg0.add(8).cast::<*mut u8>();
                                    let l31 = *arg0.add(12).cast::<usize>();
...
#[cfg(target_arch = "wasm32")]
#[link_section = "component-type:wit-bindgen:0.24.0:run-template:encoded world"]
#[doc(hidden)]
...
A\x08\x01B\x04\x01r\x02\x03keys\x05values\x04\0\x0csubstitution\x03\0\0\x01q\x01\
\x05other\x01s\0\x04\0\x05error\x03\0\x02\x03\x01!fermyon:spin-template/types@0.\
0.1\x05\0\x02\x03\0\0\x05error\x02\x03\0\0\x0csubstitution\x01B\x1d\x02\x03\x02\x01\
\x01\x04\0\x05error\x03\0\0\x02\x03\x02\x01\x02\x04\0\x0csubstitution\x03\0\x02\x04\
\0\x04file\x03\x01\x01i\x04\x01p\x05\x01@\0\0\x06\x04\0\x15[static]file.list-all\
\x01\x07\x01h\x04\x01@\x01\x04self\x08\0s\x04\0\x11[method]file.path\x01\x09\x01\
j\x01s\x01\x01\x01@\x01\x04self\x08\0\x0a\x04\0\x11[method]file.read\x01\x0b\x01\
p}\x01j\x01\x0c\x01\x01\x01@\x01\x04self\x08\0\x0d\x04\0\x18[method]file.read-bi\
nary\x01\x0e\x01@\x01\x06prompts\0s\x04\0\x06prompt\x01\x0f\x01@\x01\x06prompts\0\
\x7f\x04\0\x07confirm\x01\x10\x01ps\x01@\x02\x06prompts\x05items\x11\0}\x04\0\x06\
select\x01\x12\x01p\x03\x01@\x02\x04texts\x0dsubstitutions\x13\0\x0a\x04\0\x0fsu\
bstitute-text\x01\x14\x03\x01\x1efermyon:spin-template/ui@0.0.1\x05\x03\x01B\x10\
\x02\x03\x02\x01\x01\x04\0\x05error\x03\0\0\x02\x03\x02\x01\x02\x04\0\x0csubstit\
ution\x03\0\x02\x01o\x02ss\x01p}\x01o\x02s\x05\x01q\x04\x15copy-file-substituted\
\x01\x04\0\x0dcopy-file-raw\x01\x04\0\x0awrite-file\x01\x04\0\x11write-file-bina\
ry\x01\x06\0\x04\0\x06action\x03\0\x07\x01p\x03\x01p\x08\x01r\x02\x0dsubstitutio\
ns\x09\x07actions\x0a\x04\0\x07execute\x03\0\x0b\x01j\x01\x0c\x01\x01\x01@\0\0\x0d\
\x04\0\x03run\x01\x0e\x04\x01$fermyon:spin-template/template@0.0.1\x05\x04\x04\x01\
(fermyon:spin-template/run-template@0.0.1\x04\0\x0b\x12\x01\0\x0crun-template\x03\
